# Лабораторная работа Студента группы DPI 22-1 Галкина Дениса Сергеевича
Тема: "Асинхронное программирование"
Название лабораторной: "Мультипроцессорные вычисления"
Пожалуйста, смотрите файлы логов они иллюстрируют многопоточность на больших матрицах.
Результаты вычислений представлены в файлах:
- large_matrix_results.txt
- results.txt
